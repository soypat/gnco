...
// NewEarth returns the world as we know it.
func NewEarth() *World {
	return &World{
		mass:           5.973332e24,
		c20:            -4.8416685e-4,
		semiMajorAxis:  6378137, // WGS84 [m]
		weii:           7.292114999999999893e-05,
		radius:         6370987.,
...
type World struct {
	...
	semiMajorAxis  float64 // semi-major axis of planet [m]
	weii           float64 // Angular rotation of planet [rad/s]
...
func (w *World) GeocentricFromEarthFixedCoords(sBIE md3.Vec, epochTime float64) GeocentricCoords {
	...
	long := asinlong(sBIE.Y, sBIE.X) - w.weii*epochTime + w.celestialLong
